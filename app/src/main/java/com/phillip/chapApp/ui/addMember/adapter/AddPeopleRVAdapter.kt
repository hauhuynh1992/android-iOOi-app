...
class AddPeopleRVAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (type == EDIT_TYPE) {
            var searchEdit: View =
                (holder as AddPeopleRVAdapter.EditTextViewHolder).itemView.edtSearch.findViewById(R.id.search_plate)
            ...
            (holder as UserViewHolder).itemView.tvName.text = item.name
            if (item.isSelected) {
